...
//
//       gchar* text help_viewer_get_text( HelpViewer* helpViewer, int* id )
...
//
//      void help_tree_store_set_text( HelpViewer* helpViewer, int id, gchar* text )
...
struct _HelpViewerClass
{
    ...
    void (* edited) ( HelpViewer* helpViewer );
    void (* replaced) ( HelpViewer* helpViewer );
};
