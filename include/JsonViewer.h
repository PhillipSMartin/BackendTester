...
//
//       gchar* text json_viewer_get_json_string( JsonViewer* jsonViewer, int* id )
...
//
//      void json_tree_store_set_json_string( JsonViewer* jsonViewer, int id, gchar* text )
...
struct _JsonViewerClass
{
    ...
    void (* json_edited) ( JsonViewer* jsonViewer );
    void (* json_replaced) ( JsonViewer* jsonViewer );
};

GType json_viewer_get_type( void ) G_GNUC_CONST;
GtkWidget* json_viewer_new( Logger* logger, gboolean expandFirstRow = FALSE );
